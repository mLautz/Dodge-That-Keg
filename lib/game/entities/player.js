...
.defines(function(){
	EntityPlayer = ig.Entity.extend({
		...
		init: function(x, y, settings){
			...
			this.addAnim('fadeIn', 0.5, [15,14,13,12]);
			this.addAnim('fadeOut', 0.5, [12,13,14,15]);
		},
		...
		animateIn: function(){
			//set animation to fade in at level load
		},

		animateOut: function(){
			//set animation to fade out at level completion
		},
