	...
	MainGame = ig.Game.extend({
		...
		init: function(){
			...
			if(ig.ua.mobile){
				...
				this.buttons = [
					new ig.TouchButton('leftArrow', 40, ypos, 60, 47, this.buttonImage, 0),
					new ig.TouchButton('rightArrow', 40 + (ig.system.width/8), ypos, 60, 47, this.buttonImage, 1),
					new ig.TouchButton('mobileJump', ig.system.width/2, 0, ig.system.width/2, ig.system.height)
