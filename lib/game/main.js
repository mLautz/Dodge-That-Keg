...
.defines(function(){
	MainGame = ig.Game.extend({
		...
		init: function(){
			...
			this.levelEnterSound.volume = 0.8,
			this.levelCompleteSound.volume = 0.8,
		...
		update: function(){
			...
			if(player){
				...
				this.screen.y = player.pos.y - ig.system.height/2 - ig.system.height/6;
			}
	...
	InstructionScreen = ig.Game.extend({
		...
		draw: function(){
			...
			if(!ig.ua.mobile){
				...
				this.instructText.draw('Tap to begin!', x, y + 100, ig.Font.ALIGN.CENTER);
			}
		},
	});
